...
│ Xiaomi's Big Data SRE team.                                                     │
│                                                                                 │
│ Previously at Google's Data Center team (GCP production infra) and AMD. Off the │
│ clock, I run a self-hosted AMD EPYC + MI50 server in my room (hunting for used  │
│ Tesla V100s to make this a proper cluster).                                     │
